...
--   at:        2025-11-28 18:55:15 PST
--   site:      Oracle Database 21c
--   type:      Oracle Database 21c



DROP TABLE AVA.IMS_ANALYSIS_RESULTS CASCADE CONSTRAINTS 
;

DROP TABLE AVA.IMS_ANALYSIS_TYPES CASCADE CONSTRAINTS 
;

DROP TABLE AVA.IMS_CURRENCY_TYPES CASCADE CONSTRAINTS 
;

DROP TABLE AVA.IMS_DIVIDENDS CASCADE CONSTRAINTS 
;

DROP TABLE AVA.IMS_EARNINGS CASCADE CONSTRAINTS 
;

DROP TABLE AVA.IMS_EXCHANGES CASCADE CONSTRAINTS 
;

DROP TABLE AVA.IMS_HIST_MKT_DATA CASCADE CONSTRAINTS 
;

DROP TABLE AVA.IMS_INVESTMENTS CASCADE CONSTRAINTS 
;

DROP TABLE AVA.IMS_LISTED_TO_NYSE CASCADE CONSTRAINTS 
;

DROP TABLE AVA.IMS_LOAD_DONE CASCADE CONSTRAINTS 
;

DROP TABLE AVA.IMS_LOAD_TODOS CASCADE CONSTRAINTS 
;

DROP TABLE AVA.IMS_OVRNGHT_HLDG_DETAILS CASCADE CONSTRAINTS 
;

DROP TABLE AVA.IMS_OVRNGHT_HLDG_SUMMARIES CASCADE CONSTRAINTS 
;

DROP TABLE AVA.IMS_PRICE_COMPARISON CASCADE CONSTRAINTS 
;

DROP TABLE AVA.IMS_PROCESS_CONTROL CASCADE CONSTRAINTS 
;

DROP TABLE AVA.IMS_SECTORS CASCADE CONSTRAINTS 
;

DROP TABLE AVA.IMS_STREAK_DETAILS CASCADE CONSTRAINTS 
;

DROP TABLE AVA.IMS_STREAK_SUMMARIES CASCADE CONSTRAINTS 
;

DROP TABLE AVA.IMS_TRADE_OPPS CASCADE CONSTRAINTS 
;
...
CREATE TABLE AVA.IMS_ANALYSIS_RESULTS 
    ( 
...
;
CREATE INDEX AVA.IAR_IAT_FK_IDX ON AVA.IMS_ANALYSIS_RESULTS 
    ( 
     IAR_IAT_TYPE ASC 
    ) 
;
CREATE INDEX AVA.IAR_INV_FK_IDX ON AVA.IMS_ANALYSIS_RESULTS 
    ( 
     IAR_INV_TICKER ASC 
    ) 
;
CREATE UNIQUE INDEX AVA.IAR_PK_IDX ON AVA.IMS_ANALYSIS_RESULTS 
    ( 
     IAR_IAT_TYPE ASC , 
     IAR_INV_TICKER ASC , 
     IAR_DATE ASC 
...
ALTER TABLE AVA.IMS_ANALYSIS_RESULTS 
    ADD CONSTRAINT IAR_PK PRIMARY KEY ( IAR_IAT_TYPE, IAR_INV_TICKER, IAR_DATE ) ;

CREATE TABLE AVA.IMS_ANALYSIS_TYPES 
    ( 
     IAT_TYPE  VARCHAR2 (10 CHAR)  NOT NULL , 
     IAT_DESCR VARCHAR2 (45 CHAR)  NOT NULL 
    ) 
;
CREATE UNIQUE INDEX AVA.IAT_PK_IDX ON AVA.IMS_ANALYSIS_TYPES 
    ( 
     IAT_TYPE ASC 
    ) 
;

ALTER TABLE AVA.IMS_ANALYSIS_TYPES 
    ADD CONSTRAINT IAT_PK PRIMARY KEY ( IAT_TYPE ) ;

CREATE TABLE AVA.IMS_CURRENCY_TYPES 
    ( 
     CTY_SYMBOL VARCHAR2 (15 CHAR)  NOT NULL , 
     CTY_NAME   VARCHAR2 (20 CHAR) 
    ) 
;
CREATE UNIQUE INDEX AVA.CTY_PK_IDX ON AVA.IMS_CURRENCY_TYPES 
    ( 
     CTY_SYMBOL ASC 
    ) 
;

ALTER TABLE AVA.IMS_CURRENCY_TYPES 
    ADD CONSTRAINT CTY_PK PRIMARY KEY ( CTY_SYMBOL ) ;

CREATE TABLE AVA.IMS_DIVIDENDS 
    ( 
...
;
CREATE INDEX AVA.DIV_INV_FK_IDX ON AVA.IMS_DIVIDENDS 
    ( 
     DIV_INV_TICKER ASC 
    ) 
;
CREATE UNIQUE INDEX AVA.DIV_PK_IDX ON AVA.IMS_DIVIDENDS 
    ( 
     DIV_INV_TICKER ASC , 
     DIV_REPORT_TYPE ASC , 
     DIV_AS_OF_DATE ASC , 
...
;
CREATE INDEX AVA.EAR_INV_FK_IDX ON AVA.IMS_EARNINGS 
    ( 
     EAR_INV_TICKER ASC 
    ) 
;
CREATE UNIQUE INDEX AVA.EAR_PK_IDX ON AVA.IMS_EARNINGS 
    ( 
     EAR_INV_TICKER ASC , 
     EAR_REPORT_TYPE ASC , 
     EAR_AS_OF_DATE ASC , 
...
;
CREATE UNIQUE INDEX AVA.EXC_PK_IDX ON AVA.IMS_EXCHANGES 
    ( 
     EXC_SYMBOL ASC 
    ) 
;

ALTER TABLE AVA.IMS_EXCHANGES 
    ADD CONSTRAINT EXC_PK PRIMARY KEY ( EXC_SYMBOL ) ;

CREATE TABLE AVA.IMS_HIST_MKT_DATA 
    ( 
...
;
CREATE INDEX AVA.HMD_DATES_IDX ON AVA.IMS_HIST_MKT_DATA 
    ( 
     HMD_START_DATETIME ASC , 
     HMD_END_DATETIME ASC 
    ) 
;
CREATE UNIQUE INDEX AVA.HMD_PK_IDX ON AVA.IMS_HIST_MKT_DATA 
    ( 
     HMD_INV_TICKER ASC , 
     HMD_START_DATETIME ASC , 
     HMD_END_DATETIME ASC , 
...
;
CREATE INDEX AVA.INV_EXC_FK_IDX ON AVA.IMS_INVESTMENTS 
    ( 
     INV_EXC_SYMBOL ASC 
    ) 
;
CREATE UNIQUE INDEX AVA.INV_PK_IDX ON AVA.IMS_INVESTMENTS 
    ( 
     INV_TICKER ASC 
    ) 
;
CREATE INDEX AVA.INV_SEC_FK_IDX ON AVA.IMS_INVESTMENTS 
    ( 
     INV_SEC_NAME ASC 
    ) 
;
CREATE INDEX AVA.INV_LOAD_STATUS_IDX ON AVA.IMS_INVESTMENTS 
    ( 
     INV_LOAD_STATUS ASC 
    ) 
;
CREATE INDEX AVA.INV_LOAD_PRICES_IDX ON AVA.IMS_INVESTMENTS 
    ( 
     INV_LOAD_PRICES ASC 
    ) 
;
CREATE INDEX AVA.INV_LOAD_DIVS_IDX ON AVA.IMS_INVESTMENTS 
    ( 
     INV_LOAD_DIVS ASC 
    ) 
;
CREATE INDEX AVA.INV_LOAD_EARNINGS_IDX ON AVA.IMS_INVESTMENTS 
    ( 
     INV_LOAD_EARNINGS ASC 
    ) 
;
CREATE INDEX AVA.INV_LOAD_STREAKS_IDX ON AVA.IMS_INVESTMENTS 
    ( 
     INV_LOAD_STREAKS ASC 
    ) 
;

ALTER TABLE AVA.IMS_INVESTMENTS 
    ADD CONSTRAINT INV_PK PRIMARY KEY ( INV_TICKER ) ;

CREATE TABLE AVA.IMS_LISTED_TO_NYSE 
    ( 
...
CREATE TABLE AVA.IMS_LOAD_DONE 
    ( 
...
;
CREATE INDEX AVA.LDO_INV_FK_IDX ON AVA.IMS_LOAD_DONE 
    ( 
     LDO_INV_TICKER ASC 
    ) 
;
CREATE UNIQUE INDEX AVA.LDO_PK_IDX ON AVA.IMS_LOAD_DONE 
    ( 
     LDO_REQ_TYPE ASC , 
...
;
CREATE INDEX AVA.LTO_INV_FK_IDX ON AVA.IMS_LOAD_TODOS 
    ( 
     LTO_INV_TICKER ASC 
    ) 
;
CREATE UNIQUE INDEX AVA.LTO_PK_IDX ON AVA.IMS_LOAD_TODOS 
    ( 
     LTO_INV_TICKER ASC , 
...
;
CREATE INDEX AVA.OHD_OHS_FK_IDX ON AVA.IMS_OVRNGHT_HLDG_DETAILS 
    ( 
     OHD_OHS_ID ASC 
    ) 
;
CREATE UNIQUE INDEX AVA.OHD_PK_IDX ON AVA.IMS_OVRNGHT_HLDG_DETAILS 
    ( 
     OHD_OHS_ID ASC , 
     OHD_NUMBER_DAYS ASC , 
...
;
CREATE INDEX AVA.OHS_INV_FK_IDX ON AVA.IMS_OVRNGHT_HLDG_SUMMARIES 
    ( 
     OHS_INV_TICKER ASC 
    ) 
;
CREATE UNIQUE INDEX AVA.OHS_PK_IDX ON AVA.IMS_OVRNGHT_HLDG_SUMMARIES 
    ( 
     OHS_ID ASC 
    ) 
;

ALTER TABLE AVA.IMS_OVRNGHT_HLDG_SUMMARIES 
    ADD CONSTRAINT OHS_PK PRIMARY KEY ( OHS_ID ) ;

CREATE TABLE AVA.IMS_PRICE_COMPARISON 
    ( 
...
;
CREATE INDEX AVA.PCO_DATE_IDX ON AVA.IMS_PRICE_COMPARISON 
    ( 
     PCO_DATETIME ASC 
    ) 
;
CREATE INDEX AVA.PCO_INV_FK1_IDX ON AVA.IMS_PRICE_COMPARISON 
    ( 
     PCO_INV_TICKER1 ASC 
    ) 
;
CREATE INDEX AVA.PCO_INV_FK1_IDXV2 ON AVA.IMS_PRICE_COMPARISON 
    ( 
     PCO_INV_TICKER2 ASC 
    ) 
;
CREATE INDEX AVA.PCO_PK_IDX ON AVA.IMS_PRICE_COMPARISON 
    ( 
     PCO_INV_TICKER1 ASC , 
     PCO_INV_TICKER2 ASC , 
     PCO_DATETIME ASC 
...
ALTER TABLE AVA.IMS_PRICE_COMPARISON 
    ADD CONSTRAINT PCO_PK PRIMARY KEY ( PCO_INV_TICKER1, PCO_INV_TICKER2, PCO_DATETIME ) ;

CREATE TABLE AVA.IMS_PROCESS_CONTROL 
    ( 
     PCN_PROCESS_NAME   VARCHAR2 (50 BYTE)  NOT NULL , 
     PCN_SERVER_NAME    VARCHAR2 (30 BYTE)  NOT NULL , 
     PCN_STATUS_SETTING VARCHAR2 (6 BYTE) 
    ) 
;
CREATE INDEX AVA.PCN_PK_IDX ON AVA.IMS_PROCESS_CONTROL 
    ( 
     PCN_PROCESS_NAME ASC , 
     PCN_SERVER_NAME ASC 
    ) 
;

ALTER TABLE AVA.IMS_PROCESS_CONTROL 
    ADD CONSTRAINT PCN_PK PRIMARY KEY ( PCN_PROCESS_NAME, PCN_SERVER_NAME ) ;

CREATE TABLE AVA.IMS_SECTORS 
    ( 
     SEC_NAME      VARCHAR2 (50 CHAR)  NOT NULL , 
     SEC_REP_ORDER NUMBER (10)  NOT NULL 
    ) 
;
CREATE UNIQUE INDEX AVA.SEC_PK_IDX ON AVA.IMS_SECTORS 
    ( 
     SEC_NAME ASC 
    ) 
;

ALTER TABLE AVA.IMS_SECTORS 
    ADD CONSTRAINT SEC_PK PRIMARY KEY ( SEC_NAME ) ;

CREATE TABLE AVA.IMS_STREAK_DETAILS 
    ( 
...
;
CREATE UNIQUE INDEX AVA.STD_PK_IDX ON AVA.IMS_STREAK_DETAILS 
    ( 
     STD_STS_ID ASC , 
...
;
CREATE INDEX AVA.STD_STS_FK_IDX ON AVA.IMS_STREAK_DETAILS 
    ( 
     STD_STS_ID ASC 
    ) 
;

ALTER TABLE AVA.IMS_STREAK_DETAILS 
    ADD CONSTRAINT STD_PK PRIMARY KEY ( STD_STS_ID, STD_STREAK_START_DATETIME, STD_STREAK_END_DATETIME, STD_STREAK_TYPE ) ;

CREATE TABLE AVA.IMS_STREAK_SUMMARIES 
    ( 
...
;
CREATE INDEX AVA.STS_DATE_IDX ON AVA.IMS_STREAK_SUMMARIES 
    ( 
     STS_DATE ASC 
    ) 
;
CREATE INDEX AVA.STS_INV_FK_IDX ON AVA.IMS_STREAK_SUMMARIES 
    ( 
     STS_INV_TICKER ASC 
    ) 
;
CREATE UNIQUE INDEX AVA.STS_PK_IDX ON AVA.IMS_STREAK_SUMMARIES 
    ( 
     STS_ID ASC 
    ) 
;

ALTER TABLE AVA.IMS_STREAK_SUMMARIES 
    ADD CONSTRAINT STS_PK PRIMARY KEY ( STS_ID ) ;

CREATE TABLE AVA.IMS_TRADE_OPPS 
    ( 
...
;
CREATE INDEX AVA.TOP_DATES_IDX ON AVA.IMS_TRADE_OPPS 
    ( 
     TOP_START_DATE ASC , 
     TOP_END_DATE ASC 
    ) 
;
CREATE INDEX AVA.TOP_INV_FK_IDX ON AVA.IMS_TRADE_OPPS 
    ( 
     TOP_INV_TICKER ASC 
    ) 
;
CREATE INDEX AVA.TOP_PK_IDX ON AVA.IMS_TRADE_OPPS 
    ( 
     TOP_INV_TICKER ASC , 
     TOP_START_DATE ASC , 
     TOP_END_DATE ASC 
...
ALTER TABLE AVA.IMS_TRADE_OPPS 
...
ALTER TABLE AVA.IMS_DIVIDENDS 
    ...
    REFERENCES AVA.IMS_INVESTMENTS 
    ( 
     INV_TICKER
    ) 
;
...
ALTER TABLE AVA.IMS_ANALYSIS_RESULTS 
    ...
    REFERENCES AVA.IMS_ANALYSIS_TYPES 
    ( 
     IAT_TYPE
    ) 
;
...
ALTER TABLE AVA.IMS_INVESTMENTS 
    ...
    REFERENCES AVA.IMS_CURRENCY_TYPES 
    ( 
     CTY_SYMBOL
    ) 
;
...
ALTER TABLE AVA.IMS_OVRNGHT_HLDG_DETAILS 
    ...
    REFERENCES AVA.IMS_OVRNGHT_HLDG_SUMMARIES 
    ( 
     OHS_ID
    ) 
;
...
ALTER TABLE AVA.IMS_STREAK_DETAILS 
    ...
    REFERENCES AVA.IMS_STREAK_SUMMARIES 
    ( 
     STS_ID
    ) 
;
...
CREATE SEQUENCE ims.IMS_OVRNGHT_HLDG_SUMMARIES_OHS 
START WITH 1 
    NOCACHE 
    ORDER ;

CREATE OR REPLACE TRIGGER ims.OHS_PRE_INSERT 
BEFORE INSERT ON AVA.IMS_OVRNGHT_HLDG_SUMMARIES 
FOR EACH ROW 
WHEN (NEW.OHS_ID IS NULL) 
BEGIN 
    :NEW.OHS_ID := ims.IMS_OVRNGHT_HLDG_SUMMARIES_OHS.NEXTVAL; 
END;
/

CREATE SEQUENCE ims.IMS_STREAK_SUMMARIES_STS_ID 
START WITH 1 
    NOCACHE 
    ORDER ;

CREATE OR REPLACE TRIGGER ims.STS_PRE_INSERT 
BEFORE INSERT ON AVA.IMS_STREAK_SUMMARIES 
FOR EACH ROW 
WHEN (NEW.STS_ID IS NULL) 
BEGIN 
    :NEW.STS_ID := ims.IMS_STREAK_SUMMARIES_STS_ID.NEXTVAL; 
END;
/
