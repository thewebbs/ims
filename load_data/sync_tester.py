...
try:
    # Connect to TWS
    #if not tws.connect_and_start("127.0.0.1", 7497, 0):
    if not tws.connect_and_start("127.0.0.1", 4002, 0):
    ...
    #my_what_to_show="BID"    
    print("requesting for end date time",my_end_date_time, 
    ...
    try:
        ...
        #for bar in bars[:50]: # Print first 50 bars
        #for bar in bars[:len(bars)]: # Print all of it
