#------------------------------------------------------------
# Filename  : agent_load_early_morning_todos.py
# Project   : ava
#
...
def agent_load_early_morning_todos(database, rec_type, inv_ticker, 
...
if __name__ == "__main__":
    ...
    # note that the date time isn't used for EARLYAM as it picks up the latest
    ...
    agent_load_early_morning_todos(database           = database, 
                                   rec_type           = rec_type, 
                                   inv_ticker         = inv_ticker, 
                                   str_start_datetime = str_start_datetime, 
                                   str_end_datetime   = str_end_datetime, 
