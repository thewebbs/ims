#------------------------------------------------------------
# Filename  : agent_load_dividend_todos.py
# Project   : ava
#
...
# Date       Ver Who Change
# ---------- --- --- ------
# 2020-01-19   1 MW  Initial write
# ...
# 2021-12-19 100 DW  Added version 
# 2022-01-04 101 DW  Improved logging
...
def agent_load_dividend_todos(database, rec_type, freq_type, inv_ticker, 
...
if __name__ == "__main__":
    ...
    agent_load_dividend_todos(database           = database, 
                              rec_type           = rec_type, 
                              freq_type          = freq_type,
                              inv_ticker         = inv_ticker, 
                              str_start_datetime = str_start_datetime, 
